 ...
 <div className='container mt-4' >
  ...
  <div >
    ...
    <section
      ...
      className="container py-5 small text-secondary">

      <h2 className="fs-5 mb-3 fw-bold">Política de Privacidad</h2>

      <p>Aquí puedes escribir el texto o información sobre la privacidad. Esta

      sección detalla cómo se recopila, utiliza y protege la información

      proporcionada por los usuarios de la página.</p>
      ...
      <h2 className="fs-5 mb-3 fw-bold">Términos y condiciones</h2>

      <p>Aquí puedes escribir los términos de uso de tu sitio. Incluye reglas y responsabilidades que aceptan los usuarios cuando utilizan la página.
